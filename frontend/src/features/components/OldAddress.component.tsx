...
export const OldAddress: React.FC<{ value: Address; onChange: (a: Address) => void }> = ({ value, onChange }) => {
  const a = value
  return (
    <div className="space-y-4">
      <h3 className="text-base font-semibold text-gray-900">Auszugsadresse</h3>
